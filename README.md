...
running command...
$ scrollsdk (--version)
scroll-sdk-cli/0.0.0 linux-x64 node-v20.11.0
...
_See code: [src/commands/hello/index.ts](https://github.com/scroll-tech/scroll-sdk-cli/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/scroll-tech/scroll-sdk-cli/blob/v0.0.0/src/commands/hello/world.ts)_
