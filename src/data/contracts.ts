...
export const contracts: DeployedContract[] = [
    ...
    { name: "L1_ETH_GATEWAY_IMPLEMENTATION_ADDR", initializes: false, owned: false, layer: Layer.L1 },
    { name: "L1_ETH_GATEWAY_PROXY_ADDR", initializes: true, owned: true, layer: Layer.L1 },
    { name: "L1_WETH_GATEWAY_IMPLEMENTATION_ADDR", initializes: false, owned: false, layer: Layer.L1 },
    { name: "L1_WETH_GATEWAY_PROXY_ADDR", initializes: true, owned: true, layer: Layer.L1 },
    ...
    { name: "L2_WETH_GATEWAY_PROXY_ADDR", initializes: true, owned: true, layer: Layer.L2 },
